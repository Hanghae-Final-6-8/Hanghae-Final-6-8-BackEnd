...
//    private final LikeRepository likeRepository;
    ...
    public PostsSliceResponseDto getPostList(Pageable pageable) {
        ...
        Slice<PostsInterfaceJoinVO> postsInterfaceJoinVO = postsRepository.findAllWithPostImagesPageing(
            pageable);
    ...
    public PostsSliceResponseDto getMyPostList(Long id, Pageable pageable) {
        ...
        Slice<PostsInterfaceJoinVO> postsInterfaceJoinVO = postsRepository.findAllByUsers_Id(id,
            pageable);
...
//        return new PostsRequestDto(board,Like);
        PostsInterfaceJoinVO postsInterfaceJoinVO = postsRepository.findPostsByIdWithPostImages(
            post_id);
